...
// 加密 ecb模式      string des_encrypt_chs(const string &clearText, const string &key)
...
{  
	...
	unsigned char *cipherText = new unsigned char[vecCiphertext.size()]; // 密文  
...
// 解密 ecb模式     string des_decrypt(const string &cipherText, const string &key)
...
{   
	...
	char *clearText = new char[vecCleartext.size()];  // 明文
